...
namespace catEncyption_core
{
    public class MainProgram
    {
                ...
                switch (sourceText)
                {
                    ...
                    case "info":
                        ...
                        Console.WriteLine("This program is written by Tim Chiu.\n" +
                            "This program can help you encrypt any text into the form of \"喵喵!! 喵!!!!\" or \"MeowMeow!! Meow!!!!\"\n" +
                            "==============\n ");
                        break;
        ...
        {
            Console.WriteLine("Do you want to use 喵 or Meow?\n" +
                "Type \"1\" for \"喵\"\n" +
                "Type \"2\" for \"Meow\" ");
